...
Now execute the statement you just wrote by pressing `F5` or by clicking the execute button TODO: (show execute btn image);
...
> **ABOUT** Correctly speaking: 
> *these [ ] are brackets not these ( ), 
> *these ( ) are parenthesis and these { } are braces. 
> #### *Know the difference!*
