...
![img - 1 to many relationship example](https://zeit-optipng-server-01.c1i44.now.sh/learnsql/r_one_to_many.png)
...
![img - 1 to 1 relationship example](https://zeit-optipng-server-01.c1i44.now.sh/learnsql/r_one_to_one.png)
...
![img - many to many relationship](https://zeit-optipng-server-01.c1i44.now.sh/learnsql/r_many_to_many.png)
...
![img - composite entity](https://zeit-optipng-server-01.c1i44.now.sh/learnsql/r_composite.png)
> **composite entity**
...
![img - recursive relationship](https://zeit-optipng-server-01.c1i44.now.sh/learnsql/r_recursive.png)
