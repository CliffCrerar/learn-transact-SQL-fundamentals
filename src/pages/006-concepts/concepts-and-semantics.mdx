...
import {themeConfig} from '../../../docz.config.js'
...
![img - 1 to many relationship example](https://s3-eu-west-1.amazonaws.com/cdn-aws-infinityarc.tk/img/learnsql/r_one_to_many.png)
...
![img - 1 to 1 relationship example](https://s3-eu-west-1.amazonaws.com/cdn-aws-infinityarc.tk/img/learnsql/r_one_to_one.png)
...
![img - many to many relationship](https://s3-eu-west-1.amazonaws.com/cdn-aws-infinityarc.tk/img/learnsql/r_many_to_many.png)
...
![img - composite entity](https://s3-eu-west-1.amazonaws.com/cdn-aws-infinityarc.tk/img/learnsql/r_composite.png)
> **composite entity**
...
![img - recursive relationship](https://s3-eu-west-1.amazonaws.com/cdn-aws-infinityarc.tk/img/learnsql/r_recursive.png)
