...
![img - 1 to many relationship example](http://ex-online-server-01.gq/img/r_one_to_many.png)
...
![img - 1 to 1 relationship example](http://ex-online-server-01.gq/img/r_one_to_one.png)
...
![img - many to many relationship](http://ex-online-server-01.gq/img/r_many_to_many.png)
...
![img - composite entity](http://ex-online-server-01.gq/img/r_composite.png)
> ### **composite entity**
...
![img - recursive relationship](http://ex-online-server-01.gq/img/r_recursive.png)
